...
public class DataUtils {
    ...
    public static List<Task> getTasks() {
        Task task1 = new Task("Read Java 8 in action", TaskType.LEARNING, LocalDate.of(2015, Month.SEPTEMBER, 20)).addTag("java").addTag("java8").addTag("books");
        ...
        Task task3 = new Task("Read Effective Java", TaskType.LEARNING, LocalDate.of(2015, Month.SEPTEMBER, 21)).addTag("java").addTag("books");
        Task task4 = new Task("Write a blog on Stream API", TaskType.WRITING, LocalDate.of(2015, Month.SEPTEMBER, 21)).addTag("writing").addTag("stream").addTag("java8");
